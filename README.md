<p align="center">
    <img src="agent_icons/vectr.svg" alt="VECTR" style="width: 300px;" />
</p>
<hr />

# VECTR

This is a Mythic agent for interacting with the 3rd party service, [VECTR](https://github.com/SecurityRiskAdvisors/VECTR).

This doesn't build a payload, but instead generates a "callback" within Mythic that allows you to interact with VECTR's API. 

Once you have VECTR running, set your API key value, VECTR_API_KEY, as a user secret in the Mythic UI (red key on your operator settings page).
